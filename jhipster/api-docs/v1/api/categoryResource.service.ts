...
export class CategoryResourceService {
    ...
    public createCategoryUsingPOST(category: Category, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.post<Category>(`${this.basePath}/api/categories`,
            category,
            {
    ...
    public getAllCategoriesUsingGET(observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Array<Category>>(`${this.basePath}/api/categories`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public getCategoryUsingGET(id: number, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.get<Category>(`${this.basePath}/api/categories/${encodeURIComponent(String(id))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
    ...
    public updateCategoryUsingPUT(category: Category, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        ...
        return this.httpClient.put<Category>(`${this.basePath}/api/categories`,
            category,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
