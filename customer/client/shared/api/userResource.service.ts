...
export class UserResourceService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public searchUsingGET(query: string, observe?: 'body', reportProgress?: boolean): Observable<Array<User>>;
    public searchUsingGET(query: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<Array<User>>>;
    public searchUsingGET(query: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<Array<User>>>;
    public searchUsingGET(query: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {
        if (query === null || query === undefined) {
            throw new Error('Required parameter query was null or undefined when calling searchUsingGET.');
        }
        ...
        return this.httpClient.get<Array<User>>(`${this.configuration.basePath}/api/_search/users/${encodeURIComponent(String(query))}`,
            {
                withCredentials: this.configuration.withCredentials,
                headers: headers,
                observe: observe,
