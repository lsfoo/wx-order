...
export class ProductResourceService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public deleteProductUsingDELETE(
    id: number,
    observe?: 'body',
    reportProgress?: boolean
  ): Observable<any>
  ...
  public deleteProductUsingDELETE(
    ...
    return this.httpClient.delete<any>(
      `${this.basePath}/api/products/${encodeURIComponent(String(id))}`,
      {
        withCredentials: this.configuration.withCredentials,
        headers: headers,
        observe: observe,
  ...
  public searchProductsUsingGET(
    ...
    if (query === null || query === undefined) {
      throw new Error(
        'Required parameter query was null or undefined when calling searchProductsUsingGET.'
      )
    }
    ...
    return this.httpClient.get<Array<Product>>(
      `${this.basePath}/api/_search/products`,
      {
        params: queryParameters,
        withCredentials: this.configuration.withCredentials,
        headers: headers,
